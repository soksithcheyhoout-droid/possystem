                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('cost') is-invalid @enderror" 
                                       id="cost" name="cost" value="{{ old('cost', $product->cost) }}" step="0.01" min="0">
                            </div>
                            @error('cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="d-flex align-items-end h-100">
                                @if($product->hasDiscount())
                                    <div class="alert alert-success mb-0 flex-grow-1">
                                        ...
                                        <strong>{{ $product->discount_percentage }}% OFF!</strong><br>
                                        <small>Save ${{ number_format($product->price - $product->getFinalPrice(), 2) }}</small>
                                    </div>
                                @endif
                            </div>
                        </div>
